        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Definaiton = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descrpition = table.Column<string>(type: "ntext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MilitarySatusId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementAppUsers_MilitaryStatuses_MilitarySatusId",
                        column: x => x.MilitarySatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementAppUsers_MilitarySatusId",
                table: "AdvertisementAppUsers",
                column: "MilitarySatusId");
